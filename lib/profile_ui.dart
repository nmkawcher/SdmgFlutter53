    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          Text("Contrary to popular belief Lorem Ipsum is not simply random textIt has roots in a piece of classicalLatin literature from 45 BC,making it over 2000 years old.Richard McClintock,a Latin professor at Hampden-Sydney College",style: TextStyle(
            fontSize: 12
          ),),
        ],
      ),
